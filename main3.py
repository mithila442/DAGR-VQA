...
from sal_withoutreg import UNetWithoutRegisterTokens
    ...
    with open('epoch_loss.csv', mode='w', newline='') as file:
        ...
        for epoch in range(num_epochs):
            ...
            if epoch>=100 and epoch % 10 == 0:
                save_checkpoint(model, optimizer, epoch, epoch_loss, path=f'checkpoint_epoch_{epoch + 1}_woreg.pth')
...
if __name__ == '__main__':
    ...
    if phase == "train":
        ...
        model = UNetWithoutRegisterTokens(in_channels=3, out_channels=1)
